...
(if you have any other version installed from scala or scalate than 0.3, then you will need to explicitly reference both ie. --with scalate-0.7.1,scala-0.7.2)
